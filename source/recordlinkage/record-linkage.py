...
df1['ActiveDiner_Lookup'] = df1[['1_restaurant', '1_address', '1_country']].apply(lambda x: '_'.join(str(x)), axis=1)

df2['DiningGuide_Lookup'] = df2[['2_restaurant', '2_address']].apply(lambda x: '_'.join(str(x)), axis=1)
