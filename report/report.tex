...
\section{Esperimenti}
\subsection{Dataset}
Il dataset su cui sono stati effettuati gli esperimenti è un elenco di ristoranti di Manhattan, estratti settimanalmente da Gennaio a Marzo 2009 da 12 siti web. Le informazioni base presenti in ogni dataset comprendono il nome del ristorante, l'indirizzo e la città.
...
Di seguito mostriamo alcuni risultati ottenuti attraverso il lavoro di preprocessing.\\
Nel caso di MenuPages, per esempio, inizialmente avevamo i dati in questo formato:\\
\begin{figure}[H]
\centering
...
a seguito del preprocessing invece otteniamo informazioni più chiare, unendo l'informazione sull'indirizzo proveniente da Google come segue:\\
...
% indirizzi google API, esempio di ciò che viene ritornato e di tutta l'informazine cosa abbiamo mantenuto

% come facciamo a dire che siamo soddisfatti dell'integrazione dei DB,
% partiamo dal fatto che rappresenta un caso reale, valutazione empirica.
% Con ECM probabilà 3 livelli di soglie  
