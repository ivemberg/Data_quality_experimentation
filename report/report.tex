...
\end{enumerate}
%si potrebbe mettere l'immagine a pagina 30 del pdf di batini oppure pagina 36 | OK metti schema procedimento record linkage

%titolo di sta parte? metodologie?
...
%cercare se si può aggiungere qualcosa
...
E sono presenti le seguenti informaizoni: %da finire
\begin{itemize}
...
Da questa fase sono risultati due dataset, rispettivamente di 7524 e di 13379 record, invece dei %inserire somma tutti record 
...
% come facciamo a dire che siamo soddisfatti dell'integrazione dei DB, || PERCHè SI
